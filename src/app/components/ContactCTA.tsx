      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-8">
        <div className="bg-[#171717] md:rounded-[40px] rounded-[20px] relative overflow-hidden">
          ...
          <motion.div
            ...
            className="relative z-10 py-6 px-2 md:py-8 md:px-12 flex flex-col items-center gap-6"
          >
            {/* Header */}
            <motion.div 
            ...
            >
              <div className="font-['Urbanist',sans-serif] text-[24px] md:text-[64px] leading-none tracking-[-1.28px] text-white mb-4">
            ...
            <motion.form 
              ...
              className="w-full max-w-[800px] flex flex-col gap-4 md:gap-6"
            >
              ...
              <div>
                <div className="relative">
                  <input
                    ...
                    } rounded-[16px] px-4 md:px-8 py-2.5 md:py-3.5 text-white text-[14px] md:text-[20px] placeholder:text-white/50 focus:outline-none focus:border-[#3b82e6] transition-all`}
                  />
                  {errors.name && (
                    <motion.div
              ...
              <div>
                <div className="relative">
                  <select
                    ...
                    } rounded-[16px] px-4 md:px-8 py-2.5 md:py-3.5 text-white/50 text-[14px] md:text-[20px] placeholder:text-white/50 focus:outline-none focus:border-[#3b82e6] transition-all appearance-none`}
                  >
                ...
                <div className="relative">
                  <textarea
                    ...
                    } rounded-[16px] px-4 md:px-8 py-2 md:py-2 text-white text-[14px] md:text-[18px] placeholder:text-white/50 focus:outline-none focus:border-[#3b82e6] transition-all resize-none`}
                  />
                  {errors.message && (
                    <motion.div
                      initial={{ opacity: 0, x: -10 }}
