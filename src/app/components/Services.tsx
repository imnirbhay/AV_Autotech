              ...
              {services && Array.isArray(services) && services.length > 0 ? (
                services.slice(0, 3).map((service: any) => (
                  <motion.div
                    ...
                    className="group"
                  >
                    <div className="relative aspect-square md:aspect-auto md:h-[400px] rounded-[12px] overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 cursor-pointer bg-gradient-to-br from-[#3b82e6] to-[#1e3a8a]">
                      {/* Background Image */}
                      {service.image && (
                        <img
                          src={service.image}
