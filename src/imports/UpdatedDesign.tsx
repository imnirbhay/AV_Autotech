import svgPaths from "./svg-h3rzuq72qp";
...
import imgFrame376 from "figma:asset/ece298d0ec2c16f10310d45724b276a6035cb503.png";
import imgFrame344 from "figma:asset/ba56d13b70a40e5606603b63d86c379e61a059e9.png";
import imgFrame347 from "figma:asset/6fddbd2b03eab49a4f76b3a0e34d3e8a40d52a9f.png";
import imgFrame349 from "figma:asset/ccdd92b1bfee9ab07bef167270461de5ba241a23.png";
import imgUnsplashHXbdghd1JJa from "figma:asset/2307e9fc8d99bba15eb3c4f90c31a624850eda34.png";
import imgIndiaMartSymbolPng1 from "figma:asset/cd49b1e25e58eededaf41103636e4344d7190b9b.png";
...
import imgFrame341 from "figma:asset/b7832939d60c2e2f523d75cb89617d3e5b0c1dd8.png";
import imgFrame326 from "figma:asset/3f0c7249e0ba3d9e3c1556a26c76670f11a0068c.png";
import imgFrame334 from "figma:asset/3ca1004d99f31e7c29ed2c95b6d655e7e8e6e2ec.png";
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-end leading-none relative shrink-0 text-[#171717] text-center text-nowrap">
    ...
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0">
      <div className="absolute h-[405px] left-[83px] top-[230px] w-[811px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 811 405">
          <g id="Ellipse 2">
            <path d={svgPaths.p1fce4b00} fill="url(#paint0_radial_23_940)" />
          </g>
          <defs>
            <radialGradient cx="0" cy="0" gradientTransform="matrix(5.99421 616.147 -1233.82 11.9736 399.722 6.37541)" gradientUnits="userSpaceOnUse" id="paint0_radial_23_940" r="1">
      ...
      <div className="absolute h-[458px] left-[141px] top-[185px] w-[267px]">
        <div className="absolute inset-[-17.47%_-29.96%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 427 618">
            <g filter="url(#filter0_f_23_950)" id="Rectangle 23">
              <path d={svgPaths.p31c7800} fill="black" fillOpacity="0.25" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="618" id="filter0_f_23_950" width="427" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_23_950" stdDeviation="40" />
              </filter>
            </defs>
          </svg>
        </div>
  ...
  return (
    <div className="overflow-clip relative shrink-0 size-[78px]" data-name="skill-icons:instagram">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 78 78">
        <g id="Group">
          <path d={svgPaths.p224e1600} fill="url(#paint0_radial_23_850)" id="Vector" />
          <path d={svgPaths.p224e1600} fill="url(#paint1_radial_23_850)" id="Vector_2" />
          <g id="Vector_3">
            <path d={svgPaths.p11ea9a00} fill="white" />
          </g>
        </g>
        <defs>
          <radialGradient cx="0" cy="0" gradientTransform="translate(20.7187 84.0075) rotate(-90) scale(77.3038 71.8986)" gradientUnits="userSpaceOnUse" id="paint0_radial_23_850" r="1">
            <stop stopColor="#FFDD55" />
            <stop offset="0.1" stopColor="#FFDD55" />
            <stop offset="0.5" stopColor="#FF543E" />
            <stop offset="1" stopColor="#C837AB" />
          </radialGradient>
          <radialGradient cx="0" cy="0" gradientTransform="translate(-13.0653 5.61874) rotate(78.681) scale(34.5552 142.438)" gradientUnits="userSpaceOnUse" id="paint1_radial_23_850" r="1">
...
function Frame64() {
  return (
    <div className="bg-[#f6faff] content-stretch flex flex-col gap-[96px] h-[744px] items-center justify-center overflow-clip p-[80px] relative rounded-[50px] shrink-0 w-[1288px]">
      <div className="absolute flex h-[1424.303px] items-center justify-center left-[55.03px] top-[-282.3px] w-[1483.965px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[150deg]">
          <div className="h-[983px] relative w-[1146px]">
            <div className="absolute inset-[-0.78%_-1.05%_-0.3%_-1.01%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1169.62 993.624">
                <path d={svgPaths.p221a2280} id="Vector 6" stroke="var(--stroke-0, #ABCAF5)" strokeOpacity="0.2" strokeWidth="24" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame32() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col gap-[60px] h-[5593px] items-center left-[-2px] w-[1514px]">
      <Frame31 />
      <Group11 />
      <Frame64 />
      <Frame38 />
...
function Frame58() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Montserrat:Bold_Italic',sans-serif] font-bold italic leading-[normal] relative shrink-0 text-[32px] text-nowrap text-white tracking-[-0.64px]">AV Autotech</p>
    </div>
  );
}
...
function Frame59() {
  return (
    <div className="[grid-area:1_/_1] content-stretch flex gap-[14px] h-[86px] items-center justify-center ml-0 mt-0 relative">
      <Frame58 />
    </div>
  );
}
...
function Frame70() {
  return (
    <div className="bg-[#3b82e6] content-stretch flex items-center justify-center overflow-clip px-[40px] py-[20px] relative rounded-[60px] shrink-0">
      <p className="font-['Urbanist:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[20px] text-nowrap text-white tracking-[-0.4px]">Home</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[20px] relative rounded-[60px] shrink-0">
      <p className="font-['Urbanist:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-nowrap text-white tracking-[-0.4px]">About Us</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[20px] relative rounded-[60px] shrink-0">
      <p className="font-['Urbanist:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-nowrap text-white tracking-[-0.4px]">Service</p>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip px-[24px] py-[20px] relative rounded-[60px] shrink-0">
      <p className="font-['Urbanist:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-nowrap text-white tracking-[-0.4px]">Project</p>
    </div>
  );
}
...
function Frame74() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip px-[24px] py-[20px] relative rounded-[60px] shrink-0">
      <p className="font-['Urbanist:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-nowrap text-white tracking-[-0.4px]">Contact</p>
    </div>
  );
}
...
function Frame76() {
  return (
    <div className="content-stretch flex items-center justify-between pl-[40px] pr-[24px] py-0 relative shadow-[0px_4px_10px_0px_#070c2f] shrink-0 w-[1280px]">
      <Group8 />
      <Frame75 />
    </div>
  );
...
function Component6() {
  return (
    <div className="bg-[#171717] content-stretch flex h-[86px] items-center justify-center rounded-[50px] shadow-[0px_4px_8px_0px_rgba(0,37,88,0.2)] shrink-0 sticky top-0 w-[1280px]" data-name="Component 13">
      <Frame76 />
    </div>
  );
}
...
function Frame82() {
  return (
    <div className="content-stretch flex flex-col items-center pb-0 pointer-events-auto pt-[40px] px-0 sticky top-0 w-[1512px]">
...
export default function UpdatedDesign() {
  return (
    <div className="bg-[#e5f0ff] relative size-full" data-name="Updated Design">
      <div className="absolute h-[849px] left-[calc(58.33%-19px)] top-[3205px] w-[1384px]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1384 849">
          <g id="Vector">
            <path d={svgPaths.p192ad400} fill="#3B82E6" fillOpacity="0.08" />
          </g>
        </svg>
      </div>
      <div className="absolute flex h-[849px] items-center justify-center left-[-748px] top-[4230px] w-[1384px]">
        <div className="flex-none rotate-[180deg] scale-y-[-100%]">
          <div className="h-[849px] relative w-[1384px]" data-name="Vector">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1384 849">
              <g id="Vector">
                <path d={svgPaths.p192ad400} fill="#3B82E6" fillOpacity="0.1" />
              </g>
            </svg>
          </div>
        </div>
      </div>
      <div className="absolute flex h-[2159.143px] items-center justify-center left-[calc(25%+102.46px)] top-[-230px] w-[2063.126px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[50deg]">
          <div className="h-[1109px] relative w-[1888px]">
            <div className="absolute inset-[-0.72%_-0.42%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1904 1125.01">
                <path d={svgPaths.p3574fd00} id="Vector 5" stroke="var(--stroke-0, #3B82E6)" strokeLinecap="round" strokeOpacity="0.15" strokeWidth="16" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="absolute flex h-[1922.99px] items-center justify-center left-[-748px] top-[-342.39px] w-[2189.509px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[329deg]">
          <div className="h-[1109px] relative w-[1888px]">
            <div className="absolute inset-[-2.16%_-1.27%_-2.17%_-1.27%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1936 1157.02">
                <path d={svgPaths.p344b3b80} id="Vector 4" stroke="var(--stroke-0, #3B82E6)" strokeLinecap="round" strokeOpacity="0.15" strokeWidth="48" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="absolute flex h-[2009.08px] items-center justify-center left-[calc(8.33%+74px)] top-[1255.07px] w-[1330.823px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[277deg]">
          <div className="h-[1109px] relative w-[1888px]">
            <div className="absolute inset-[-2.16%_-1.27%_-2.17%_-1.27%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1936 1157.02">
                <path d={svgPaths.p344b3b80} id="Vector 3" stroke="var(--stroke-0, #3B82E6)" strokeLinecap="round" strokeOpacity="0.15" strokeWidth="48" />
              </svg>
            </div>
          </div>
        </div>
      ...
      <Frame32 />
      <div className="absolute bottom-0 h-[5726px] left-0 pointer-events-none top-0">
        <Frame82 />
      </div>
    </div>
  );
